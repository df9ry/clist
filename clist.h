...
#ifndef CLISTS_LIST_H_
#define CLISTS_LIST_H_

/**
 * @file
 * @brief Use #include <clists/list.h> to use this library.
 */
...
/*
 * Thease are some very useful makros commonly used in kernel code.
 */
